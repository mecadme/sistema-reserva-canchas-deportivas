package ec.edu.ups.reservas.reservas.security;
    ...
    SecurityFilterChain chain(HttpSecurity http, JwtAuthenticationConverter converter) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/reservas").hasRole("USUARIO")
                        .requestMatchers("/api/v1/reservas/mias").hasRole("USUARIO")
                        .requestMatchers(HttpMethod.GET, "/api/v1/reservas").hasRole("ADMINISTRADOR")
