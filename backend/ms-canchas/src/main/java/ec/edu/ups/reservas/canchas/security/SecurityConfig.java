package ec.edu.ups.reservas.canchas.security;
    ...
    SecurityFilterChain chain(HttpSecurity http, JwtAuthenticationConverter converter) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/canchas/**").authenticated()
                        .requestMatchers("/api/v1/canchas/**").hasRole("ADMINISTRADOR")
